...
<head>
  ...
  <link rel="shortcut icon" href="favicon.ico" type="image/x-icon">
    ...
    <link rel="stylesheet" type="text/css" href="./themes/pmahomme/css/theme.css?v=5.1.3&nocache=1693581207ltr&server=1">
...
<body>
  ...
  <div class="pma_quick_warp"><div class="drop_list"><button title="Recent tables" class="drop_button btn">Recent</button><ul id="pma_recent_list"><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=paf&table=bills">`paf`.`bills`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=paf&table=payment">`paf`.`payment`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=items&table=items">`items`.`items`</a></li></ul></div><div class="drop_list"><button title="Favorite tables" class="drop_button btn">Favorites</button><ul id="pma_favorite_list"><li class="warp_link">There are no favorite tables.</li></ul></div><div class="clearfloat"></div></div>
  ...
  <div id="pma_console_container">
    <div id="pma_console">
                ...
                <div class="message welcome">
                    ...
                    <span class="hide" id="instructions-1">
                        Press Enter to execute query                    </span>
                            ...
                            targetdb="items" targettable="items">
            ...
            Queried time
                            ...
                            <span class="query">CREATE TABLE `items`.`items` ( `itemID` INT(11) NOT NULL ,  `itemcode` VARCHAR(10) NOT NULL ,  `itemname` VARCHAR(30) NOT NULL ,  `itemprice` DECIMAL(7) NOT NULL ,  `itemdesc` VARCHAR(200) NOT NULL ) ENGINE = InnoDB;</span>
                        </div>
            ...
            Queried time
                            ...
                            <span class="query">CREATE TABLE `paf`.`bills` ( `bid` VARCHAR(5) NOT NULL AUTO_INCREMENT ,  `uid` VARCHAR(5) NOT NULL ,  `punitread` INT NOT NULL ,  `nunitread` INT NOT NULL ,  `noofunits` INT NOT NULL ,  `unitprice` INT NOT NULL ,  `totalbill` FLOAT NOT NULL ,    PRIMARY KEY  (`bid`)) ENGINE = InnoDB;</span>
                        </div>
                                            <div class="message history collapsed hide"
                            targetdb="paf" targettable="bills">
                            <div class="action_content">
            ...
            Queried time
                            ...
                            <span class="query">CREATE TABLE `paf`.`bills` ( `bid` INT NOT NULL AUTO_INCREMENT ,  `uid` VARCHAR(5) NOT NULL ,  `punitread` INT NOT NULL ,  `nunitread` INT NOT NULL ,  `noofunits` INT NOT NULL ,  `unitprice` INT NOT NULL ,  `totalbill` FLOAT NOT NULL ,    PRIMARY KEY  (`bid`)) ENGINE = InnoDB;</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="paf" targettable="bills">
                            <div class="action_content">
            ...
            Queried time
                            ...
                            <span class="query">INSERT INTO `bills` (`bid`, `uid`, `punitread`, `nunitread`, `noofunits`, `unitprice`, `totalbill`) VALUES (NULL, &#039;&#039;, &#039;&#039;, &#039;&#039;, &#039;&#039;, &#039;&#039;, &#039;&#039;), (NULL, &#039;U001&#039;, &#039;100&#039;, &#039;150&#039;, &#039;50&#039;, &#039;10&#039;, &#039;500&#039;);</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="paf" targettable="bills">
                            <div class="action_content">
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `bills`</span>
                                            ...
                                            <div class="message history collapsed hide"
                            targetdb="paf" targettable="payment">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
            ...
            Queried time
                            ...
                            <span class="query">CREATE TABLE `paf`.`payment` ( `accountNo` INT NOT NULL AUTO_INCREMENT ,  `customerName` VARCHAR(200) NOT NULL ,  `unitsConsumed` VARCHAR(200) NOT NULL ,  `chargeForUnits` VARCHAR(200) NOT NULL ,  `adjuments` VARCHAR(200) NOT NULL ,  `totalAmount` VARCHAR(200) NOT NULL ,    PRIMARY KEY  (`accountNo`)) ENGINE = InnoDB;</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="paf" targettable="bills">
                            <div class="action_content">
